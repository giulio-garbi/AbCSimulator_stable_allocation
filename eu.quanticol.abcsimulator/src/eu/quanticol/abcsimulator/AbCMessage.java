...
public class AbCMessage {
	 ...
	 * @param route
	 */
	public AbCMessage(AbCNode from, MessageType type, int messageIndex, ComponentMessage data, LinkedList<Integer> route, AbCNode to) {
		super();
		this.type = type;
		this.data = data;
	...
	public ComponentMessage getData() {
		return data;
	}
